export const sampleBooks = [
  ...
  { 
    ...
    author: "Kim Seonyu",
    category: "RomanceFantasy", 
    description: "เฮสเทียเข้ามาอยู่ในนิยายโรแมนซ์แฟนตาซีเรื่องโปรดที่เธอรัก แต่ในตอนท้ายของเรื่อง ไคลัสตัวละครที่เธอรักมากที่สุดกลับถึงแก่ความตาย แล้วแบบนี้เฮสเทียจะหาโอกาสมาช่วยเมนสุดที่รักอย่างไร",
  ...
  { 
    ...
    author: "HANO",
    category: "RomanceFantasy", 
    description: "จู่ๆแม่ก็ส่งฉันมาให้พ่อที่เป็นถึงดยุกปีศาจ ถึงหวาดกลัวแต่ฉันก็ต้องใช้ชีวิตอยู่ในคฤหาสน์แห่งนี้ให้ได้",
  ...
  { 
    ...
    author: "Mu",
    category: "Romance", 
    description: "เกิดใหม่เป็นนางเอกวรรณคดีที่เคยเรียนในแบบเรียน ที่โดนประนามว่าหญิงสองใจ ถ้าจะรอดจากโทษประหาร คือต้องหนี!",
  ...
  { 
    ...
    author: "HANO",
    category: "Romance", 
    description: "เพราะความฟุ่มเฟือยของราชวงศ์ทำให้ต้องมาแต่งงานกับตระกูลพ่อค้าที่รวยที่สุดในอาณาจักร จากการคลุมถุงชนกลายมาเป็นความรักที่คอยประคองกันพาอาณาจักรผ่านวิกฤต",
  ...
  { 
    ...
    author: "ซองโซจัก",
    category: "Drama", 
    description: "สามีคนนี้แจกฟรีให้เธอ เพื่อนที่ฉันคิดว่าสนิทที่สุดกลับมาแย้งสามีของฉัน ถ้าอยากได้มากนักก็เอาไปเลยเพราะสามีคนนี้มันแย่ยังไงอยู่แล้วละ",
  ...
  { 
    ...
    author: "egestigi",
    category: "Drama", 
    description: "ราชินีคนแรกของอาณาจักรสิงหะส่าหรี และมารดาผู้ให้กำเนิดกษัตริย์แห่งราชวงศ์ชวาโบราณ ความจริงที่ประจักษ์นั้นเป็นเพียงความลวงแท้ที่จริงแล้วเธอไม่มีความสุขเลย",
  ...
  { 
    ...
    author: "อัลฟาทาร์ต",
    category: "Drama", 
    description: "พระองค์เคยเป็นราชินีที่สมบูรณ์แบบ แต่ฝ่าบาทตรัสว่าไม่ต้องการผู้ร่วมบัลลังก์เฉยๆแต่คนที่เขาต้องการคือคนรักจึ่งแต่งงานใหม่ แต่จะให้นาเวียร์เสียพระเกียรติไม่ได้ จึงมีความตั้งใจที่จะแต่งงานกับฝ่าบาทประเทศเพื่อนบ้านที่อยู่ติดกัน",
  ...
  { 
    title: "โนเบลส NOBLESSE", 
    author: "ซนเจโฮ",
    category: "Fantasy", 
    description: "ไรแวมไพร์ผู้นอนหลับข้ามศตวรรษ ได้ตื่นขึ้นมาและเริ่มใช้ชีวิตใหม่ในโรงเรียนที่ แฟรงเกนสไตน์ ทาสของเขาเป็นผู้ก่อตั้งขึ้นมา วันหนึ่งเมื่อเพื่อนของไรถูกโจมตีทำให้ไรกับแฟรงเกนสไตน์ต้องต่อสู้กับศัตรูลึกลับ",
  ...
  { 
    title: "Nan Yak พันธะสัญญาดอกกล้วยไม้", 
    author: "จองฮยอนจู",
    category: "Fantasy", 
  ...
  { 
    title: "ชีวิตนักเรียนฉัน ขอคืนเถอะนะ", 
    author: "LICO",
    category: "Fantasy", 
  ...
  { 
    title: "โรงละครส่งวิญญาณ", 
    author: "LICO",
    category: "Thriller", 
    description: "นักแสดงดาวรุ่ง ประสบอุบัติเหตุร้ายแรงจนสูญเสียครอบครัว รวมถึงความสามารถในการแสดงสีหน้าไปจนหมดจะแดงสีหน้าอีกครั้งได้ก็ต่อเมื่อแสดงต่อหน้าวิญญาณ",
  ...
  { 
    title: "เรื่องเล่าจากวิญญาณ", 
    author: "QTT",
    category: "Thriller", 
    description: "เรื่องผี เรื่องวิญญาณ แล้วก็บอกว่าหลอนแต่นี่คือการรวมตัวกันของวิญญาณ เล่าเรื่องของคนที่หลอน.....กว่าวิญญาณ...",
  ...
  { 
    ...
    author: "เฟรชช่า",
    category: "Thriller", 
    description: "ท่ามกลางซากศพเดินได้ที่มีอยู่ทั่วเมือง ซอมบี้สายพันธุ์ใหม่ปรากฏตัวขึ้น พวกมันทั้งไวกว่า ฉลาดกว่า และโหดกว่า!แล้วมนุษย์ที่เหลืออยู่จะตกเป็นเหยื่อ หรือกลายเป็นพวกเดียวกับมัน?!",
  ...
  { 
    ...
    author: "ปาร์คแทจุน",
    category: "Action", 
    description: "จากหนุ่มอ้วนอัปลักษณ์ บ้านจน แถมยังถูกแกล้งที่โรงเรียนไม่เว้นแต่ละวันวันหนึ่งเขาตื่นขึ้นและพบว่า ตนเองกลายเป็นหนุ่มหล่อสุดเพอร์เฟ็คต์!! นี่เกิดอะไรขึ้นกับเขากันนะ?!!",
  ...
  { 
    ...
    author: "Lim Lina",
    category: "Action", 
    description: "พัคฮายันแวมไพร์เลือดบริสุทธิ์ที่มีจิตใจที่อ่อนโยนและมีความหวังเพียงแค่อยากจะอยู่ร่วมกับมนุษย์อย่างสงบสุข แต่เกิดคดีฆาตกรรมจากพวกแวมไพร์มากขึ้น ฉันจะต้องจัดการพวกที่ก่อเรื่องไว้!!!",
  ...
  { 
    ...
    author: "Kim Junghyun",
    category: "Action", 
    description: "นักฆ่าวัยเก๋าถูกทรยศและได้กลับมาอยู่ในร่างวัยเยาว์ของเขาไม่มีใครจำฉันได้เลยงั้นเหรอ?! ถ้างั้น ฉันนี่แหละ นักฆ่าที่เก่งที่สุดในตอนนี้!",
